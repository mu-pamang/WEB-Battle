...
<body>  
        <form method="POST" action="/qna_write_action.php" enctype="multipart/form-data">
         <form method="POST" action="/qna_write_action.php">
        ...
        <tr>
            <td bgcolor=white>
                <table class="table2">
                    ...
                    <tr>
                        <td>비밀글</td>
                        <td><input type="checkbox" value = "1" name="secret" size=10 maxlength=10></td>
                    <tr>
                       <td>파일 업로드</td>
